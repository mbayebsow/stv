...
interface PlayerControlProps  { inactive:boolean }

function PlayerControl({ inactive }:PlayerControlProps) {
  const { currentPlay, playerState, channelActiveIndex, setPlaying } = useGlobalStore();
